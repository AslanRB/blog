...
p.d = ggplot() + theme_void () + coord_fixed(ratio=0.5) +
  ...
  geom_point(aes(x=0.5:9.5/10, y=0.5), shape=21, col="black", fill="gray80", size=2) +
...
p.c = ggplot() + theme_void () + coord_fixed(ratio=0.5) +
  geom_segment(aes(x=0, xend=1, y=0.5, yend=0.5), col="gray80", size=2) +
  geom_rect(aes(xmin=0, xmax=1, ymin=0, ymax=1), col="black", fill=NA, size=1)+
  ggtitle("  Continuous r.v.")+
  geom_segment(aes(x=0, xend=0.05, y=0.5, yend=0.4))+
  geom_segment(aes(x=1, xend=0.95, y=0.5, yend=0.4))+
  annotate("text", label="0", hjust=0, vjust=1, x=0.05, y=0.4, size=4)+
  annotate("text", label="10", hjust=1, vjust=1, x=0.95, y=0.4, size=4)+
